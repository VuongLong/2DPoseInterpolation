...
#print('\n\n\nREADING TEST DATA')
TEST_DIR = ["./Yu_new/fastsong/fastsong7.txt", "./fastsong/fastsong7.txt", "./fastsong/fastsong8.txt"]
...
MISSING_MAP_DIR = "./Yu_new/fastsong/fastsong7/test_data_Aniage_num_gap/5/0_test.txt"
